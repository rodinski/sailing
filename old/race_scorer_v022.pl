...
my $version_string = "race_scorer_v03.pl version 0.3 coded: 2016_03_12";

my ($bt,$defaults) = LoadFile('./boats_2016.yaml');
my $r =  LoadFile('./2016_s1.yaml');
my $table; #ref to a data structure for later results
my $races_held = 0;  #counter


say "[Top](#top) <code>.       .</code> [Results](#Results)  ";
